...
node{    
  ...
  stage("email"){
    ...
    //echo "My secret text is '${SECRET}'"
      ...
      emailext body: "<b>Error occurred during veracode upload</b> <br> ERROR_LOG: BUILD_URL:${env.BUILD_URL}", subject: "Raffia Veacode Scan Failed ", from:'gajendrarok@gmail.com', to: 'gajendrarok@gmail.com'
