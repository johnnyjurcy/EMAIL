...
node{    
  ...
  stage("email"){
    ...
    //echo "My secret text is '${SECRET}'"
      ...
      emailext body: "Error occurred during veracode upload '\n' ERROR_LOG:</b>${e} BUILD_URL:${env.BUILD_URL}", subject: "${imageName} Veacode Scan Failed ", from:'gajendrarok@gmail.com', to: 'gajendrarok@gmail.com'
