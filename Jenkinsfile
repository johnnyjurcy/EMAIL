...
emailext body: "Error occurred during veracode upload "<br>" ERROR_LOG:</b>${e} "<br>" <br>BUILD_URL:${env.BUILD_URL}", subject: "${imageName} Veacode Scan Failed ", from:'gajendrarok@gmail.com', to: 'gajendrarok@gmail.com'
